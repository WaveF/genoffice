 ...
 * `nexoffice-popover-open` class — suspend the drag region with
 * `html.nexoffice-popover-open .your-drag-row { -webkit-app-region: no-drag; }`.
 */
...
function bumpOpenPopovers(delta: 1 | -1): void {
  ...
  document.documentElement.classList.toggle('nexoffice-popover-open', openPopovers > 0)
}
