...
import { tableRowGridCols } from '@nexoffice/pptx-engine/table-grid'
import { elementDurableId, groupChildDurableId } from '@nexoffice/pptx-engine/identity'
import { isBackgroundLikeElement } from '@nexoffice/pptx-engine/background-promote'
