...
- `@nexoffice/font-metrics`：13 项测试通过；Shell font catalog：5 项测试通过；Docs：97 文件 / 1066 项通过；Slides：44 文件 / 372 项通过；Sheets：139 文件通过、1 文件跳过，1541 项通过、1 项跳过，另有 108 项 Rust 原生测试通过。
