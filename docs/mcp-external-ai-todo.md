...
| SHT-02 | 实现 Sheets 只读 tools：context、range、formats、find、aggregate、formula trace。 | P1 | SHT-01, RBR-01 | 进行中 | Codex | Sheets adapter | context、2,000 cells 上限的显式 range、find、sum/count/average 已完成；formats/formula trace 待补。 | |
