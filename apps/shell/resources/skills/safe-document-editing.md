...
description: Core rules for working with documents through GenOffice MCP.
...
Use only public MCP tools. Never ask GenOffice to read arbitrary local paths, URLs, tokens, or file contents outside the documented media staging flow.
