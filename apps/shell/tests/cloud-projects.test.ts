...
import { gskListPastProjects, type GskPastProjectsPage } from '@nexoffice/ai-search'
import {
  cloudStoreOwner,
...
vi.mock('@nexoffice/ai-search', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@nexoffice/ai-search')>()
