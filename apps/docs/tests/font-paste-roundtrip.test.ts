...
describe('fontAttrsFromFamilyChain', () => {
  ...
  it('skips internal NexOffice aliases even at the chain head', () => {
    expect(
      fontAttrsFromFamilyChain("'NexOffice Songti SC','STSong','SimSun','Noto Serif CJK SC',serif"),
    ).toEqual({ font: 'STSong' })
  })
  ...
  it('never mistakes the range-limited GO aliases for a user East Asian font', () => {
    ...
    expect(
      fontAttrsFromFamilyChain("'PT Serif Custom','Noto Serif CJK GO','NexOffice PUA Blank',serif"),
