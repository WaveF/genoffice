...
import type { RenderNode, RenderSlide, ShapeRenderNode } from '@nexoffice/pptx-render'
...
function ShowMediaLayer({
  ...
  const nodes = slide.nodes.filter(
    (n): n is import('@nexoffice/pptx-render').PictureRenderNode =>
      n.type === 'picture' && !!(n as import('@nexoffice/pptx-render').PictureRenderNode).media,
  )
