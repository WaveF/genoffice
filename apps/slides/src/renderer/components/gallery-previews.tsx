 ...
 * is shared across apps via @nexoffice/ui (re-exported here for existing
 * imports); SmartArt thumbs reuse the engine's layout math so preview and
 * insert result always match.
 */
import { shapePreviewPath } from '@nexoffice/ui'
import {
  layoutShapes,
  type SmartArtLayout,
} from '../../../../../packages/pptx-engine/src/smartart-layout'

export { ShapePreview, shapePreviewBox, shapePreviewPath } from '@nexoffice/ui'
