...
import { addPicture, createBlankPptx, openPptx, savePptx } from '@nexoffice/pptx-engine'
import { buildRenderSlide, type PictureRenderNode } from '@nexoffice/pptx-render'
import {
  decodeInkPayload,
  encodeInkPayload,
  inkNodeHitTest,
