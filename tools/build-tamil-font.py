#!/usr/bin/env python3
"""Build NexOffice Tamil from upstream Noto Sans Tamil, hmtx-normalized to Latha.
...
DEFAULT_OUT = "apps/docs/src/renderer/fonts/NexOfficeTamil-Regular.woff2"
FAMILY = "NexOffice Tamil"
...
def main() -> None:
    ...
    rename(font, FAMILY, "NexOfficeTamil-Regular")
    space = cmap.get(0x20)
