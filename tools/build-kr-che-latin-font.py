#!/usr/bin/env python3
"""Build NexOffice Che Latin KR: half-width Latin for -Che fixed-pitch faces.
...
ASCII-only face from the NexOffice Sans KR outlines (Noto-derived, OFL),
...
SOURCE = "apps/docs/src/renderer/fonts/NexOfficeSansKR-Regular-subset.woff2"
DEFAULT_OUT = "apps/docs/src/renderer/fonts/NexOfficeCheLatinKR.woff2"
DOTUMCHE = ("/Applications/Microsoft Word.app/Contents/Resources/DFonts/gulim.ttc", 3)
FAMILY = "NexOffice Che Latin KR"
PS_NAME = "NexOfficeCheLatinKR"
