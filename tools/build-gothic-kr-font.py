#!/usr/bin/env python3
"""Build NexOffice Gothic KR from upstream NanumGothic, with metrics untouched.
...
DEFAULT_OUT = "apps/docs/src/renderer/fonts/NexOfficeGothicKR-Regular-subset.woff2"
FAMILY = "NexOffice Gothic KR"
PS_NAME = "NexOfficeGothicKR-Regular"
PS_PREFIX = "NexOfficeGothicKR"
