#!/usr/bin/env python3
"""Build NexOffice PUA Blank: every BMP Private Use codepoint maps to one
blank 1em glyph.
...
DEFAULT_OUT = "apps/docs/src/renderer/fonts/NexOfficePUABlank.woff2"
FAMILY = "NexOffice PUA Blank"
UPM = 1000
