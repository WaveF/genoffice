#!/usr/bin/env python3
"""Normalize NexOffice Serif KR Latin metrics to Batang.
...
from Word on those documents. NexOffice Sans KR already went through the
same treatment for Malgun (normalize-kr-sans-hmtx.py +
scale-kr-sans-latin-ink.py). NexOffice Gothic KR is out of scope: it models
...
TARGETS = {
    "NexOfficeSerifKR-Regular-subset.woff2": ("batang.ttc", 0),  # Batang
}
